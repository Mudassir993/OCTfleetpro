...
(function(){
  ...
  window.octStaffAdd=octStaffAdd;window.octStaffEdit=octStaffEdit;window.octStaffSave=octStaffSave;window.octStaffDelete=octStaffDelete;window.octStaffView=octStaffView;window.octStaffUpload=octStaffUpload;window.octStaffDownload=octStaffDownload;window.octStaffRender=octStaffRender;window.showStaffEmployeePage=showStaffEmployeePage;window.installStaffNav=installStaffNav;
