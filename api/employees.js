...
function employeeOut(r){
  if(!r)return r;
  return Object.assign({},r,{employeeId:r.employee_id,name:r.name,passportNo:r.passport_no,designation:r.designation,phone:r.phone,email:r.email,joiningDate:r.joining_date?String(r.joining_date).slice(0,10):null,employmentStatus:r.employment_status,createdAt:r.created_at,updatedAt:r.updated_at,createdBy:r.created_by,updatedBy:r.updated_by});
}
